...
public class EditNextOfKinCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD
        + ": edits the details of the NOK of the patient by the index number used in the displayed patient list.\n"
     ...
     */
    public EditNextOfKinCommand(Index patientIndex, NextOfKin nokToAdd) {
